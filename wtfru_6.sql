...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 10 Mars 2015 à 22:59
...
--
CREATE TABLE `notification_combined` (
`id` int(11)
,`content` varchar(255)
,`type` varchar(50)
,`date` bigint(15)
